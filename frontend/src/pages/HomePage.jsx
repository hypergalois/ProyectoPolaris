...
function HomePage() {
	...
	const { areas, getAreas, degrees, getDegrees, degreesByArea, getDegreesByArea, awards, getAwards, subjects, getSubjects, subjectsByDegree, getSubjectsByDegree, errors } = useAreas();
