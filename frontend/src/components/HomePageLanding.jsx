		...
		<div className="p-10">
			...
			<div className="flex">
				...
				<div className="w-10/12 pl-4">
					...
					<p>Podrás acceder a un repositorio de proyectos realizados por los alumnos y antiguos alumnos de U-tad, filtrar el contenido en base a tus necesidades y conocer el trabajo realizado en otros grados.</p>
				</div>
			</div>
			<div className="flex">
				<div className="w-2/12">
