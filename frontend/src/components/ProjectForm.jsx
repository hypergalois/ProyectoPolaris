		...
		<form onSubmit={handleSubmit(onSubmit)}>
			...
			<div>
				...
				<Select
					...
					onChange={(selectedLetter) => {
						setValue("letter", selectedLetter);
					}}
				/>
			</div>
			<div>
			...
			<div>
				...
				{teacherFields.map((field, index) => (
					<div key={field.id}>
						<input type="text" {...register(`teacher.${index}`)} placeholder="Profesor implicado" />
					</div>
				))}
			...
			<div>
				...
				{awardFields.map((field, index) => (
					<div key={field.id}>
						<input type="text" {...register(`award.${index}`)} placeholder="Premio" />
					</div>
				))}
