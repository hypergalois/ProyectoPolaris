...
function NavBar() {
	...
	if (userRole === "ADMIN") {
		navigation.push({ name: "DASHBOARD", href: "/dashboard", current: false, admin: true });
	}
	...
	return (
		<>
							...
							<div className="relative flex items-center justify-between h-16">
								...
								<div className="flex-1 flex items-center justify-between">
									...
									<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
										<button type="button" onClick={handleOpenProjectFormPopup} className="inline-flex items-center bg-white px-4 py-2 mr-2 rounded-full text-white hover:bg-blue-400 focus:outline-none">
			...
			<Popup title="SUBE EL PROYECTO" openPopup={openProjectFormPopup} closePopup={handleCloseProjectFormPopup}>
