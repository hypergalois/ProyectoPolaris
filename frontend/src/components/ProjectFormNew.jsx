...
const ProjectForm = ({ closePopup }) => {
    ...
    const { register, control, handleSubmit, formState: { errors }, watch, setValue, getValues } = methods;
    ...
    const {
        field: {
            value: academicCourseValue,
            onChange: academicCourseOnChange,
