	...
	return (
		<div className="filter-container flex space-x-4 mx-20 m-8 text-blue-500">
			...
			<div className="relative w-4/5">
				<input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Buscar" className="rounded border-blue-500 placeholder-blue-500 pr-10 pl-3 py-2 w-full font-semibold" />
